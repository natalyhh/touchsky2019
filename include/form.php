...
$toemails[] = array(
				'email' => 'contact@touchsky.tech', // Your Email Address
				'name' => 'CONTACT TOUCHSKY' // Your Name
			);
...
$fromemail = array(
				'email' => 'contact@touchsky.tech', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'TOUCHSKY' // Company Name
			);
